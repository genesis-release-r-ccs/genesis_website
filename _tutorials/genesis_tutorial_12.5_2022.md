...
\\( \\displaystyle U"(x) = U(x)+\\Delta U\^{\\text{GaMD}}\\left(U(x)\\right) + \\Delta U_i\^{\\text{REUS}}\\left(\\xi(x)\\right),\\)
...
![](/assets/images/2022_06_gareus_fig1.png)
...
([tutorial22-12.5](/assets/tutorial_files/2022_06_tutorial22-12.5.tar.gz)). This tutorial consists of seven steps: 1) system setup, 2)
...
[tutorial22-12.5_full](/assets/tutorial_files/2022_07_tutorial22-12.5_full.tar.gz), which includes "`1_setup`" and
...
\\( \\displaystyle p(\\xi) = \\left\<\\exp\[\\beta \\Delta U\^{\\text{GaMD}}\]\\right\>'\_{\\xi} \\frac{p\'(\\xi)}{\\left\<\\exp\[\\beta \\Delta U\^{\\text{GaMD}}\]\\right\>'}.\\)
...
![](/assets/images/2022_06_gareus_fig2.png)
...
![](/assets/images/2022_06_gareus_fig3.png)
