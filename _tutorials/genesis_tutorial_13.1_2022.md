...
![](/assets/images/2022_03_fig1.png){: width="600" .align-center}
...
![](/assets/images/2022_03_equil-1.png){: width="600" .align-center}
...
constant of the corresponding image. In the first step, we used weak restraints (`constant1 = 1.0` kcal/mol/rad<sup>2</sup> and `constant2 = 1.0` kcal/mol/rad<sup>2</sup>) to relax the system. Then, a strong force constant
(`constant1 = 100.0` kcal/mol/rad<sup>2</sup> and `constant2 = 100.0` kcal/mol/rad<sup>2</sup> ), as recommended for string simulation, is used in the second equilibration step. Reference values for the restraints are
specified by `reference1` and `reference2`.
...
![](/assets/images/2022_03_rpath-1.png){: width="600" .align-center}
...
The content of `INP` is shown below. Again, the reference values `reference1` and `reference2`
...
![](/assets/images/2022_04_pmf1d.png){: width="400" .align-center}
