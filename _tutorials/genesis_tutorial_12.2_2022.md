...
([tutorial22-12.2.tar.gz](/assets/tutorial_files/2022_07_tutorial22-12.2.tar.gz)). This tutorial consists of five steps: 1) system setup, 2)
...
we make a symbolic link to the CHARMM toppar directory (see [Tutorial 2.1](/tutorials/genesis_tutorial_2.1_2022/)).
...
addition, each replica keeps [the rule of hybrid MPI/OpenMP parallelization for single MD simulation](faq/faq1/index.html).
...
commands are example to plot the replica index that has Parameter 10 (k = 1.2 kcal/mol/Å^2^ and r = 10.08Å):
...
[![](/assets/images/2022_06_chapter_12-2_figure1.png)]
...
[![](/assets/images/2022_06_chapter_12-2_figure2-1.png)]
...
[![](/assets/images/2022_06_chapter_12-2_figure3.png)]
...
[![](/assets/images/2022_06_chapter_12-2_figure4-2.png)]
...
![](/assets/images/2022_06_chapter_12-2_figure6-1.png)
...
```
(2000).
[](http://scitation.aip.org/content/aip/journal/jcp/113/15/10.1063/1.1308516)
```
...
```
9058
(2002). [](http://scitation.aip.org/content/aip/journal/jcp/116/20/10.1063/1.1472510)
```
...
```
(2012).
[](http://journals.aps.org/prl/abstract/10.1103/PhysRevLett.108.108102)
```
