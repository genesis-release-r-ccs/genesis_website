...
Same as the other CG tutorials (tutorial [11.1](/tutorials/genesis_tutorial_11.1_2022/), [11.2](/tutorials/genesis_tutorial_11.2_2022/), [11.3](/tutorials/genesis_tutorial_11.3_2022/)), we have to first install the
...
([tutorial22-11.4.tar.gz](/assets/tutorial_files/2022_03_tutorial22-11.4.tar.gz)). This tutorial consists of two parts:
...
In the `param` directory, the `atom_types.itp` file contains (line 126 to 211) the parameters of the HPS potential. In the latest version of
...
\[1, 4, 5\] or any set of parameters you prefer. (Note that the developers of GENESIS do not take any responsibility of changing parameters during the execution of MD simulations.)
...
[^4] Regy, R. M., Thompson, J., Kim, Y. C. & Mittal, J. **2021**,
