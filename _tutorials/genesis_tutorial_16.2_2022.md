...
([Tutorial 16.1](/tutorials/genesis_tutorial_16.1_2022/)[)]{.underline}, the MD
simulations using the GB/SA model ([Tutorial 8.1](/tutorials/genesis_tutorial_8.1_2022/)[)]{.underline}, the coarse-grained MD
simulations using the KB Go-model ([Tutorial 7.1](/tutorials/genesis_tutorial_7.1_2022/)[)]{.underline} and the replica-exchange MD
(REMD) simulations ([Tutorial 12.1](/tutorials/genesis_tutorial_12.1_2022/)[)]{.underline}.

## Preparation 

The tutorial files are available for download here:
[tutorial22-16.2.tar.gz](/assets/tutorial_files/2022_07_tutorial22-16.2.tar.gz). As described in [Tutorial 16.1](/tutorials/genesis_tutorial_16.1_2022/),
...
[^1] M. Kulik et al., *Front. Mol. Biosci.*, [**8**, 631854 (2021)]{lang="EN-US"}.  \
[^2] O. Miyashita et al., *J. Comput. Chem.*, **38**, 1447-1461
(2017). [](https://onlinelibrary.wiley.com/doi/abs/10.1002/jcc.24785)\
[^3] J. Karanicolas and C. Brooks, *Prot. Sci.*, **11**, 2351-2361
(2002).[](https://onlinelibrary.wiley.com/doi/full/10.1110/ps.0205402)\
[^4] J. Karanicolas and C. Brooks, *J. Mol. Biol.*, **334**, 309-325
(2003).[](https://www.sciencedirect.com/science/article/abs/pii/S0022283603011999?via%3Dihub)\
[^5] T. Mori et al., *Structure*, **27**, 161-174
(2019). [](https://www.sciencedirect.com/science/article/pii/S0969212618303307)
