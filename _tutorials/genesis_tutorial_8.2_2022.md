...
-   [Preparation](genesis_tutorial_8.2_2022.md#Preparation)
-   [1. Setup](genesis_tutorial_8.2_2022.md#1_Setup)
-   [2. Minimization](genesis_tutorial_8.2_2022.md#2_Minimization)
-   [3. Equilibration](genesis_tutorial_8.2_2022.md#3_Equilibration)
-   [4. Production run](genesis_tutorial_8.2_2022.md#4_Production_run)
-   [5. Trajectory
    analysis](genesis_tutorial_8.2_2022.md#5_Trajectory_analysis)
    -   [Helix tilt angle](genesis_tutorial_8.2_2022.md#Helix_tilt_angle)
-   [References](genesis_tutorial_8.2_2022.md#References)
...
rel="noopener noreferrer"}. Please download the CHARMM program package
...
parameter and topology files for the EEF1/IMM1 model (`solver.inp`,
`toph19_eef1.1.inp`, and `param19_eef1.1.inp`) from CHARMM. Here, we
...
[4RYO](https://www.rcsb.org/structure/4RYO){target="_blank"
rel="noopener"}. In MD simulations of membrane proteins, the initial
orientation and position of the protein relative to the membrane plane
are important. The "[OPM
database](https://opm.phar.umich.edu){target="_blank" rel="noopener"}"
...
![](assets/images/2022_06_tutorial-8-2-fig1.png){.aligncenter
.wp-image-24594 fetchpriority="high" decoding="async" width="550"
height="393"
srcset="wp-content/uploads/2022/06/tutorial-8-2-fig1-300x214.png 300w, wp-content/uploads/2022/06/tutorial-8-2-fig1-768x548.png 768w, wp-content/uploads/2022/06/tutorial-8-2-fig1-20x14.png 20w, wp-content/uploads/2022/06/tutorial-8-2-fig1-30x21.png 30w, wp-content/uploads/2022/06/tutorial-8-2-fig1-40x29.png 40w, wp-content/uploads/2022/06/tutorial-8-2-fig1.png 818w"
...
![](assets/images/2022_06_tutorial-8-2-fig2.png){.aligncenter
.wp-image-24595 decoding="async" width="550" height="393"
srcset="wp-content/uploads/2022/06/tutorial-8-2-fig2-300x214.png 300w, wp-content/uploads/2022/06/tutorial-8-2-fig2-768x548.png 768w, wp-content/uploads/2022/06/tutorial-8-2-fig2-20x14.png 20w, wp-content/uploads/2022/06/tutorial-8-2-fig2-30x21.png 30w, wp-content/uploads/2022/06/tutorial-8-2-fig2-40x29.png 40w, wp-content/uploads/2022/06/tutorial-8-2-fig2.png 818w"
sizes="(max-width: 550px) 100vw, 550px"}
...
([tutorial22-8.2.tar.gz](assets/tutorial_files/2022_06_tutorial22-8.2.tar.gz){.mtli_attachment
.mtli_zip}). The tutorial consists of five steps: 1) system setup, 2)
...
![](assets/images/2022_06_tutorial-8-2-fig3.png){.alignnone
.size-medium .wp-image-24642 decoding="async" width="300" height="300"
srcset="wp-content/uploads/2022/06/tutorial-8-2-fig3-300x300.png 300w, wp-content/uploads/2022/06/tutorial-8-2-fig3-150x150.png 150w, wp-content/uploads/2022/06/tutorial-8-2-fig3-20x20.png 20w, wp-content/uploads/2022/06/tutorial-8-2-fig3-30x30.png 30w, wp-content/uploads/2022/06/tutorial-8-2-fig3-40x40.png 40w, wp-content/uploads/2022/06/tutorial-8-2-fig3.png 601w"
sizes="(max-width: 300px) 100vw, 300px"}

#### [ 5. Trajectory analysis ]{#5_Trajectory_analysis}

##### [Helix tilt angle]{#Helix_tilt_angle}
...
![](assets/images/2022_06_tutorial-8-2-tilt_angle.png){.aligncenter
.wp-image-24633 loading="lazy" decoding="async" width="400" height="267"
srcset="wp-content/uploads/2022/06/tutorial-8-2-tilt_angle-300x200.png 300w, wp-content/uploads/2022/06/tutorial-8-2-tilt_angle-20x13.png 20w, wp-content/uploads/2022/06/tutorial-8-2-tilt_angle-30x20.png 30w, wp-content/uploads/2022/06/tutorial-8-2-tilt_angle-40x27.png 40w, wp-content/uploads/2022/06/tutorial-8-2-tilt_angle.png 720w"
